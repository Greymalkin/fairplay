...
class RankingTests(TestCase):
    ...
    def test_bob_highest_rank(self):
        bob = registration.models.Gymnast.objects.get(athlete_id=1002)
        self.assertEqual(bob.rank, 1)

    def test_john_lowest_rank(self):
        john = registration.models.Gymnast.objects.get(athlete_id=1001)
    ...
    def test_equal_place(self):
        john = registration.models.Gymnast.objects.get(athlete_id=1001)
        bob = registration.models.Gymnast.objects.get(athlete_id=1002)
        self.assertTrue(john.place == bob.place)
    ...
    def test_bobregistration_highest_score(self):
        bob = registration.models.Gymnast.objects.get(athlete_id=1002)
        score = competition.models.GymnastEvent.objects.filter(gymnast=bob).order_by('-score')[:1]
        self.assertEqual(int(score.score), '10')
